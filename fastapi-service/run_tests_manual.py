...
def run():
    test_score_uses_experience_years()
    print("test_score_uses_experience_years passed")
    test_get_recommendations_returns_sorted_scores()
    print("test_get_recommendations_returns_sorted_scores passed")
